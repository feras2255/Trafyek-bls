...
export default function PricingToggle() {
  ...
  const data = {
    ...
    store: [
      {
        title: "تصميم وتخصيص المتجر",
        dic: "باقة أساسية لتصميم متجر إلكتروني متكامل مع واجهة مخصصة ومنتجات محدودة.",
        price: "800",
        features: [
          "تصميم واجهة احترافية",
          "متجاوب لكل الأجهزة",
          "إضافة منتجات أساسية (حتى 20 منتج)",
          "تصميم 3 بنرات",
          "ضبط اعدادات المتجر",
          " تفعيل بوابات دفع",
          "تفعيل شركات الشحن",
      ...
      {
        title: "تصميم مع منتجات وسيو",
        dic: "باقة متقدمة تشمل تصميم المتجر وإضافة المنتجات مع تحسين SEO.",
        price: "1500",
        features: [
          "تصميم واجهة احترافية",
          "متجاوب لكل الأجهزة",
          "إضافة منتجات (حتى 50 منتج)",
          "SEO متقدم",
          " تفعيل بوابات دفع",
          "تفعيل شركات الشحن",
          "20 يوم دعم فني",
          "التسليم في 7-10 أيام",
        ],
        highlight: true,
      },
      {
        title: "تصميم مع إضافة منتجات وسيو وتسويق",
        dic: "باقة متكاملة للمشاريع الكبيرة تشمل تصميم المتجر، إضافة المنتجات، SEO والتسويق الرقمي.",
        price: "4000",
        features: [
          "تصميم واجهة مخصصة متقدمة",
          "متجاوب لكل الأجهزة",
          "إضافة منتجات غير محدودة",
          "SEO كامل",
          " تفعيل بوابات دفع",
          "تفعيل شركات الشحن",
          "إعداد حملات تسويق إلكتروني",
          "تقارير وتحليلات",
          "30 يوم دعم فني",
          "التسليم في 30 يوم",
        ],
